...
@test "Path counting - if (with condition analysis)" {
  run $CCSM $TEST_SOURCE_DIR/paths_if.c $TEST_SOURCE_DIR/empty.c $TEST_SOURCE_DIR/empty.c --output-metrics=HIS_PATH --enable-condition-analysis --
  assert_success
