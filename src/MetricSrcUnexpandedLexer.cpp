...
const static std::pair<MetricType_e, MetricType_e> metricToBodyMetricMapData[] =
    {std::make_pair(METRIC_TYPE_TOKEN_DOUBLE, METRIC_TYPE_TOKEN_BODY_DOUBLE),
     ...
     std::make_pair(METRIC_TYPE_TOKEN_UNSIGNED,
                    METRIC_TYPE_TOKEN_BODY_UNSIGNED),
...
const std::map<MetricType_e, MetricType_e>
    MetricSrcUnexpandedLexer::m_metricToBodyMetricMap(
...
const static std::pair<clang::tok::TokenKind, MetricType_e>
    tokenKindToTypeMapData[] = {
        ...
        std::make_pair(clang::tok::percentequal,
                       METRIC_TYPE_TOKEN_MODULO_ASSIGN),
        ...
        std::make_pair(clang::tok::starequal,
                       METRIC_TYPE_TOKEN_ASTERISK_ASSIGN),
        ...
        std::make_pair(clang::tok::kw_sizeof,
                       METRIC_TYPE_TOKEN_OPERATOR_SIZE_OF),
        ...
        std::make_pair(clang::tok::lesslessequal,
                       METRIC_TYPE_TOKEN_LESSLESS_ASSIGN),
        ...
        std::make_pair(clang::tok::greatergreaterequal,
                       METRIC_TYPE_TOKEN_MOREMORE_ASSIGN),
...
const std::map<clang::tok::TokenKind, MetricType_e>
    MetricSrcUnexpandedLexer::m_tokenKindToTypeMap(
        tokenKindToTypeMapData,
        tokenKindToTypeMapData +
...
void MetricSrcUnexpandedLexer::CloseOutFnOrMtd(void) {
    ...
    if (m_currentUnit != NULL) {
        ...
        m_currentUnit->setSupplementary(METRIC_TYPE_TOKEN_NUMERIC_CONSTANTS,
                                        m_currentFnNumerics);
        m_currentUnit->setSupplementary(METRIC_TYPE_TOKEN_STRING_LITERALS,
                                        m_currentFnStrings);
        m_currentUnit->setSupplementary(
            METRIC_TYPE_TOKEN_UNRESERVED_IDENTIFIERS, m_currentFnIdentifiers);
        m_currentUnit->setSupplementary(METRIC_TYPE_TOKEN_CHAR_CONSTS,
...
void MetricSrcUnexpandedLexer::LexSources(
...
void MetricSrcUnexpandedLexer::EnterFileScope(void) {
    m_currentFnNumerics =
        m_currentUnit->getSupplementary(METRIC_TYPE_TOKEN_NUMERIC_CONSTANTS);
    m_currentFnStrings =
        m_currentUnit->getSupplementary(METRIC_TYPE_TOKEN_STRING_LITERALS);
    m_currentFnIdentifiers = m_currentUnit->getSupplementary(
        METRIC_TYPE_TOKEN_UNRESERVED_IDENTIFIERS);
    m_currentFnCharConsts =
        m_currentUnit->getSupplementary(METRIC_TYPE_TOKEN_CHAR_CONSTS);
}